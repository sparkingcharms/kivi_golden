...
def find_dictation(conn: sqlite3.Connection, query: str, trace) -> dict[str, Any]:
    ...
    # Two episodes of near-equal score with no distinguishing detail: ask.
...
def _resolve_recipient(conn: sqlite3.Connection, request: str, trace) -> tuple[str | None, dict | None]:
