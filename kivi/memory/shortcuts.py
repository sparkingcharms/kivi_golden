...
A shortcut is the fourth memory kind. It deliberately reuses the existing
memory architecture: status, promotion, scope, provenance, the event log and
trace. Teaching is review-first; matching is conservative; collisions are
